...
python -m asreview simulate data/Smid_2020.csv -o output/simulation/Smid_2020/state_files/sim_Smid_2020.asreview --prior-seed 535 --seed 165 -c svm -e tfidf -q max --n-query 1
...
python -m asreview simulate data/van_de_Schoot_2018.csv -o output/simulation/van_de_Schoot_2018/state_files/sim_van_de_Schoot_2018.asreview --prior-seed 535 --seed 166 -c svm -e tfidf -q max --n-query 1
